...
Module Database
    ...
    Private database As String = "prog_lang"
    ...
    Sub ComboBoxLoad(tablename As String, checkCombo As ComboBox, columnName As String)
        If Connect() Then
            Try
                ...
                For Each row As DataRow In dataTable.Rows
                    checkCombo.Items.Add(row($"{columnName}"))
                Next
